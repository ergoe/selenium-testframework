Feature: Orders Test feature
  ...
  Scenario: Test Verify user upload file to create a product
    Given Single Order with multiple products created with following parameters
      ...
      |''         |''           |Keyser	    |Soze	    |11810 W Lake Rd  |'' 	        |Vermilion	| OH  |	US	   |44089  |95	       |FAKEPROD-DOGMAIL-2	|2	     |All Steel Construction Dog Platemail (Set of 2) |	2167122996|	0.01 |
      |''         |''           |Keyser	    |Soze	    |11810 W Lake Rd  |''           |Vermilion	| OH  |	US	   |44089  |95	       |FAKEPROD-DOGSWORD	|2	     |The Original Dog Sword                          |	2167122996|	2.01 |
